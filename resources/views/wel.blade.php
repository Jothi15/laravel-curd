...
<div class="w3-bar w3-card-2 notranslate" style="padding-left:12px;padding-right:16px;">
  ...
  <div class="w3-right w3-padding-16">
    ...
    -->
    <a class="w3-bar-item w3-button bar-icon-hover w3-right w3searchbtntopnav" href="javascript:void(0)" style="padding-left:12px;padding-right:12px;margin-right:8px" onclick="gSearch(this)" title='Search W3Schools' id="nav_search_btn"><i class='fa'>&#xe802;</i></a>
    <a class="w3-bar-item w3-button bar-icon-hover w3-right w3translatebtntopnav" href="javascript:void(0)" style="padding-left:12px;padding-right:12px" onclick="gTra(this)" title='Translate W3Schools' id="nav_translate_btn"><i class='fa'>&#xe801;</i></a>
...
<script src="/lib/uic.js?v=1.0.2"></script>
<script>
